<?php 
/****
Template Name: District and Cities Template
 ***/
...
<script type="text/javascript">
    ...
    jQuery('#search_city').keyup(function(){
        var city_keyword= jQuery(this).val();
    jQuery.ajax({
    type:"POST",
    url:"<?php echo admin_url('admin-ajax.php'); ?>",
    data: {action:'get_ajax_city_data',city_keyword:city_keyword, dist_id:<?php echo $data['district_id'];?>},
