<?php 
/****
Template Name: Download Documents Template
 ***/
...
@media (max-width: 768px){
   ...
   .download-documents .main-wrap:last-child {
	   margin-bottom: 0;
    }
}
...
<div id="main-content">
 <section class="tenders download-documents sec-spacing bg pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <aside class="sidebar">
                ...
                <div class="search-documents">
                  ...
                  <button type="submit" class="search-btn">
                   ...
                   // print_r($docitem);
                    ...
                    <div class="row align-item-center main-wrap">
                        <div class="col-lg-8">
                            <div class="left">
                                <div>
